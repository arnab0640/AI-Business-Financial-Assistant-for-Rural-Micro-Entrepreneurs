 ...
 * Ministry of Social Justice and Empowerment (MoSJE) - Problem Statement #91
 */

const APP_DATA = {
  meta: {
    title: "GrameenVikas AI - MoSJE Micro-Entrepreneur Advisory Platform",
    problemStatement: "#91 - AI-Driven Hyper-Local Business Advisory and Financial Structuring Assistant",
  ...
  translations: {
    en: {
      ...
      aiCopilotHeader: "GrameenVikas AI Copilot",
      aiCopilotSub: "Voice & Text Advisory in 7 Languages",
      quickPromptsTitle: "Quick Advisory Prompts:",
      schemeMatchHeader: "MoSJE & Govt. Scheme Eligibility Matcher",
      calcHeader: "Financial Structuring & 12-Month Projection",
      dprHeader: "1-Click Bankable Detailed Project Report (DPR)",
      dprSubtitle: "Official format recognized by Banks, NABARD, and District Industry Centers (DIC)",
      linkageHeader: "Hyper-Local Market Linkage & Buyer Connect",
      impactHeader: "Hackathon Impact & Team Code Catalyst",
    ...
    hi: {
      ...
      aiCopilotHeader: "ग्रामीण विकास एआई कोपायलट",
      aiCopilotSub: "7 भाषाओं में आवाज़ और पाठ सलाह",
      quickPromptsTitle: "त्वरित सलाह प्रश्न:",
      schemeMatchHeader: "MoSJE एवं सरकारी योजना योग्यता मिलानकर्ता",
      calcHeader: "वित्तीय संरचना एवं 12 महीने का पूर्वानुमान",
      dprHeader: "1-क्लिक बैंक योग्य विस्तृत परियोजना रिपोर्ट (DPR)",
      dprSubtitle: "बैंकों, नाबार्ड और जिला उद्योग केंद्रों द्वारा मान्यता प्राप्त आधिकारिक प्रारूप",
      linkageHeader: "अति-स्थानीय बाजार जुड़ाव और खरीदार नेटवर्क",
      impactHeader: "हैकथॉन प्रभाव और टीम कोड कैटलिस्ट",
    ...
    bn: {
      ...
      leadBadge: "নেতৃত্ব: অর্ণব গায়েন",
      ...
      navImpact: "টিম ও প্রভাব",
      heroTitle: "গ্রামীণ ক্ষুদ্র উদ্যোক্তাদের জন্য AI ব্যবসা ও আর্থিক উপদেষ্টা",
      heroSubtitle: "স্থানীয় ব্যবসা পরামর্শ পান, MoSJE প্রকল্পগুলির (VISVAS, NSFDC, NBCFDC) সুবিধা নিন এবং ৭টি আঞ্চলিক ভাষায় ব্যাংকে জমা দেওয়ার মতো প্রকল্প রিপোর্ট তৈরি করুন।",
      ...
      aiCopilotHeader: "গ্রামীণ বিকাশ AI কো-পাইলট",
      aiCopilotSub: "৭টি ভাষায় ভয়েস ও টেক্সট পরামর্শ",
      quickPromptsTitle: "দ্রুত পরামর্শ প্রশ্নাবলী:",
      schemeMatchHeader: "MoSJE ও সরকারি প্রকল্প যোগ্যতা যাচাই",
      calcHeader: "আর্থিক পরিকল্পনা ও ১২ মাসের পূর্বাভাস",
      dprHeader: "১-ক্লিকে ব্যাংকযোগ্য বিস্তারিত প্রকল্প রিপোর্ট (DPR)",
      dprSubtitle: "ব্যাংক, নাবার্ড এবং জেলা শিল্প কেন্দ্র দ্বারা স্বীকৃত অফিসিয়াল ফর্ম্যাট",
      linkageHeader: "স্থানীয় বাজার সংযোগ ও ক্রেতা নেটওয়ার্ক",
      impactHeader: "হ্যাকাথন প্রভাব ও টিম কোড ক্যাটালিস্ট",
    ...
    ta: {
      ...
      leadBadge: "தலைவர்: அர்னப் காயென்",
      ...
      navImpact: "குழு & தாக்கம்",
      heroTitle: "கிராமப்புற தொழிலதிபர்களுக்கான AI வணிக மற்றும் நிதி உதவியாளர்",
      heroSubtitle: "உள்ளூர் வணிக ஆலோசனைகளைப் பெற்று, MoSJE திட்டங்களுடன் பொருந்தி, வங்கி திட்ட அறிக்கைகளை 7 மொழிகளில் உருவாக்குங்கள்.",
      ...
      aiCopilotHeader: "கிராமின் விகாஸ் AI கோபைலட்",
      aiCopilotSub: "7 மொழிகளில் குரல் & உரை ஆலோசனை",
      quickPromptsTitle: "விரைவு ஆலோசனைகள்:",
      schemeMatchHeader: "MoSJE & அரசு திட்ட தகுதி பொருத்தம்",
      calcHeader: "நிதி கட்டமைப்பு & 12 மாத கணிப்பு",
      dprHeader: "1-கிளிக் வங்கி திட்ட அறிக்கை (DPR)",
      dprSubtitle: "வங்கிகள் மற்றும் NABARD அங்கீகரித்த அதிகாரப்பூர்வ வடிவம்",
      linkageHeader: "சந்தை இணைப்பு மற்றும் வாங்குபவர் நெட்வொர்க்",
      impactHeader: "ஹேக்கத்தான் தாக்கம் மற்றும் கோட் கேட்டலிஸ்ட்",
    ...
    mr: {
      ...
      aiCopilotHeader: "ग्रामीण विकास AI कोपायलट",
      aiCopilotSub: "7 भाषांमध्ये आवाज आणि मजकूर सल्ला",
      quickPromptsTitle: "त्वरित प्रश्न:",
      schemeMatchHeader: "MoSJE योजना पात्रता जुळवणी",
      calcHeader: "आर्थिक रचना आणि 12 महिने अंदाज",
      dprHeader: "1-क्लिक बँकयोग्य DPR अहवाल",
      dprSubtitle: "बँका आणि नाबार्ड मान्यताप्राप्त अधिकृत फॉरमॅट",
      linkageHeader: "बाजार जोडणी आणि ग्राहक नेटवर्क",
      impactHeader: "हॅकाथॉन प्रभाव आणि कोड कॅटॅलिस्ट",
    ...
    gu: {
      ...
      leadBadge: "લીડ: અર્ણબ ગાંગુલી / ગાયન",
      ...
      aiCopilotHeader: "ગ્રામીણ વિકાસ AI કોપાયલટ",
      aiCopilotSub: "7 ભાષાઓમાં વૉઇસ અને ટેક્સ્ટ સલાહ",
      quickPromptsTitle: "ઝડપી પ્રશ્નો:",
      schemeMatchHeader: "MoSJE અને સરકારી યોજના પાત્રતા",
      calcHeader: "નાણાકીય માળખું અને 12 મહિનાનું અનુમાન",
      dprHeader: "1-ક્લિક બેંક યોગ્ય DPR રિપોર્ટ",
      dprSubtitle: "બેંકો અને નાબાર્ડ દ્વારા માન્ય અધિકૃત ફોર્મેટ",
      linkageHeader: "સ્થાનિક બજાર જોડાણ અને ગ્રાહક નેટવર્ક",
      impactHeader: "હેકાથોન પ્રભાવ અને ટીમ કોડ કૅટેલિસ્ટ",
    ...
    te: {
      ...
      aiCopilotHeader: "గ్రామీణ వికాస్ AI కోపైలట్",
      aiCopilotSub: "7 భాషల్లో వాయిస్ & టెక్స్ట్ సలహా",
      quickPromptsTitle: "త్వరిత సలహా ప్రశ్నలు:",
      schemeMatchHeader: "MoSJE మరియు ప్రభుత్వ పథకాల అర్హత",
      calcHeader: "ఆర్థిక నిర్మాణం & 12 నెలల అంచనా",
      dprHeader: "1-క్లిక్ బ్యాంక్ ప్రాజెక్ట్ నివేదిక (DPR)",
      dprSubtitle: "బ్యాంకులు మరియు నాబార్డ్ ఆమోదించిన అధికారిక ఫార్మాట్",
      linkageHeader: "స్థానిక మార్కెట్ మరియు కొనుగోలుదారుల నెట్‌వర్క్",
      impactHeader: "హ్యాకథాన్ ప్రభావం & కోడ్ క్యాటలిస్ట్",
